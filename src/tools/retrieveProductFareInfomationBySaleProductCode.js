...
export const retrieveProductFareInfomationBySaleProductCodeTool = {
  name: "retrieveProductFareInfomationBySaleProductCode",
  ...
  async handler({ saleProductCode, departureDay }) {
    ...
    const functionName = "retrieveProductFareInfomationBySaleProductCodeTool.handler";
    logger.info(
      `Executing ${functionName} with saleProductCode: ${saleProductCode}, departureDay: ${departureDay}`
    );
    try {
      const result = await packageService.retrieveProductFareInfomationBySaleProductCode({
        saleProductCode,
        departureDay,
      });
      logger.info(
