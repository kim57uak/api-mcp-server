...
export const retrieveProductTabBasicInfomationBySaleProductCodeTool = {
  name: "retrieveProductTabBasicInfomationBySaleProductCode",
  ...
  async handler({ saleProductCode, departureDay }) {
    ...
    const functionName = "retrieveProductTabBasicInfomationBySaleProductCodeTool.handler";
    logger.info(
      `Executing ${functionName} with saleProductCode: ${saleProductCode}, departureDay: ${departureDay}`
    );
    try {
      const result = await packageService.retrieveProductTabBasicInfomationBySaleProductCode({
        saleProductCode,
        departureDay,
      });
      logger.info(
