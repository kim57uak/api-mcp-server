...
export const retrieveProductAirInventoryInformationBySaleProductCodeTool = {
  name: "retrieveProductAirInventoryInformationBySaleProductCode",
  ...
  async handler({ saleProductCode, departureDay }) {
    ...
    const functionName = "retrieveProductAirInventoryInformationBySaleProductCodeTool.handler";
    logger.info(
      `Executing ${functionName} with saleProdCd: ${saleProductCode}, departureDay: ${departureDay}`
    );
    try {
      const result = await packageService.retrieveProductAirInventoryInformationBySaleProductCode({
        saleProductCode,
        departureDay,
      });
      logger.info(
